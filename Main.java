public class Main {
    public static void main(String[] args) {
        ...
        "The End", -1000000000, -100000000,4); // There is no minimum requirement to unlock
        ...
        -100, 2, 1, mission1_deliver_joy_ride); // 100% chance
        ...
        -150, 2, 1, mission1_deliver_joy_ride); // 100% chance
        ...
        Choice choice1_1_fake = new Choice("Show him your fake certificates", 
            ...
            0, 2, 0.4, mission1_deliver_joy_ride); // 40% chance
        ...
        Choice choice2_drop = new Choice("Drop some items", 
            ...
            0, 2, 0.95, mission2_escape_route); // 0% chance of success. The alarm is triggered regardless
        Choice choice2_bring = new Choice("Bring all", 
            "Bring them all with you: Slower but keep the reputation point", 
            0, 5, 0.93, mission2_escape_route); // 0% chance of success. The alarm is triggered regardless
        Choice choice2_direct = new Choice("Choose the shorter but guarded way", 
            "Higher reputation rewards but lose money to bribe the guards", 
            -100, 10, 0.95, mission3_police_escape); // Lose money to bribe the guards
        Choice choice2_indirect = new Choice("Chose the longer but unguarded way", 
            "Lower risks, lower reward", 
            0, 10, 0.95, mission3_police_escape); // 95% chance of success
        ...
        100, 0, 0.85, mission3_split_loot); // 85% chance of success
        Choice choice3_fight = new Choice("Fight Back", 
            ...
            100, 0, 0.3, mission3_split_loot); // 30% chance of success but reputation -5
        ...
        Choice choice3_betray = new Choice("Betray the Crew", 
            ...
            500, -40, 1.0, endNode); // 100% success, reputation -40, money +500
